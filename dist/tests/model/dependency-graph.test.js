...
const dependency_graph_1 = require("../../model/dependency-graph");
describe('constructor', () => {
    test('construct dependency graph of size zero', () => {
        let dg = new dependency_graph_1.DependencyGraph();
...
describe('to and from string', () => {
    ...
    test('generate dependency graph from string', () => {
        ...
        let generated = dependency_graph_1.DependencyGraph.Generate(dg.toString());
